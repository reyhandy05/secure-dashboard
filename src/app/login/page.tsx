    ...
    <main className="grid min-h-screen place-items-center bg-slate-950 p-4 text-slate-100">
      <section className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-8 shadow-2xl">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <p className="font-mono text-[10px] font-bold uppercase tracking-[.2em] text-emerald-400">Northstar</p>
            <p className="text-sm font-semibold text-white">Security Console</p>
          </div>
        </div>
        ...
        <form className="mt-7 space-y-4" action={handleFormSubmit}>
          <label className="block text-xs font-semibold text-slate-400">
            Email
            <input
              className="mt-2 w-full rounded-lg border border-slate-800 bg-slate-950/80 px-4 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
              type="email"
              name="email"
